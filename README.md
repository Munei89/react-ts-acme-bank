This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app) using [cra-template-tscomplete](https://github.com/leshill/cra-template-tscomplete)
